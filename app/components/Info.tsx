...
export const RevealBento = () => {
  return (
    <div className="min-h-screen px-4 py-12 text-neutral-50">
      {/* <Logo /> */}
      <motion.div
        initial="initial"
        animate="animate"
...
const HeaderBlock = () => (
  <Block className="col-span-12 row-span-2 md:col-span-6">
    ...
    <h1 className="mb-12 text-4xl font-medium leading-tight">
      Hi, We are <span className="title">Busy Minis</span> .{" "}
      <span className="text-neutral-400">We care about your safety</span>
    </h1>
    <a
      href="#"
...
const Logo = () => {
  ...
  return (
    <svg
      ...
      className="mx-auto mb-12 fill-neutral-50"
    >
      <path
